...
namespace CupkekGames.Luna.Mobile
{
    ...
    public class SafeAreaBorder : MonoBehaviour
    {
        ...
        void ApplySafeArea()
        {
            ...
            m_Root.style.marginTop = m_TopBorder * m_Multiplier;
            m_Root.style.marginBottom = m_BottomBorder * m_Multiplier;
            m_Root.style.marginLeft = m_LeftBorder * m_Multiplier;
            m_Root.style.marginRight = m_RightBorder * m_Multiplier;
