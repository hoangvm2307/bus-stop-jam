...
namespace CupkekGames.Luna.Demo.Game.Standart
{
    public class MainMenuViewExample : MainMenuView<GameSaveDataExample, GameSaveMetadataExample>
    {
        ...
        protected override void Awake()
        {
            ...
            List<TooltipContainerSetup> setups = new()
            {
                new TooltipContainerSetup(
                  ...
                  null,
                  null,
                  new UIColor(UIColorName.SECONDARY, UIColorValue.V_900),
                  new UIColor(UIColorName.SECONDARY, UIColorValue.V_400)
                )
            };
        ...
        protected override void OnButtonContinueClicked()
        {
            ...
            SceneLoader.Instance.LoadScene(2, SceneTransitionDatabase.Instance.Transitions.GetValue("CircleWithInput"));
#else
            SceneLoader.Instance.LoadScene(2, SceneTransitionDatabase.Instance.Transitions.GetValue("FadeWithInput"));
#endif
#else
#if UNITY_SHADER_GRAPH
            SceneLoader.Instance.LoadScene(2, SceneTransitionDatabase.Instance.Transitions.GetValue("Circle"));
#else
