...
{
  public abstract class KeyValueDatabaseSO<TKey, TValue> : ScriptableObject, IKeyValueDatabase<TKey, TValue>
  {
    ...
    public void EditorCopy(KeyValueDatabase<TKey, TValue> pairs)
    {
      _pairs.EditorCopy(pairs.EditorList);
    }
