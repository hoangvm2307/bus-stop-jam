...
{
    public class GridViewPaginationDemo : UIViewComponent
    {
        // Settings
        [Header("GridView Settings")]
        [SerializeField] private int _lineCount = 3;
        [SerializeField] private int _perLine = 3;
