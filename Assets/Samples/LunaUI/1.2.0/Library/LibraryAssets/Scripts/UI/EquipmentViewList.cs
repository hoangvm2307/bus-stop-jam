...
{
    public class EquipmentViewList : UIViewComponent
    {
        ...
        private InventoryViewList _inventoryView;
        ...
        protected override void Awake()
        {
            ...
            ListView container = inventoryElement.Q<ListView>("InventorySlotContainer");
            ...
            _inventoryView = new InventoryViewList(
                _itemDatabase,
                _inventory,
                _itemSlotTemplate,
                gameObject,
            ...
            _inventoryView.SetSlotPerLine(_buttonCountPerLine);
            if (_itemWidth > 0)
            {
                _inventoryView.SetDynamicItemPerLine(_itemWidth);
            }
