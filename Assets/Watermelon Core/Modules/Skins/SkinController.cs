...
namespace Watermelon
{
    ...
    public class SkinControllerSave : ISaveObject
    {
        ...
        private const string SAVE_KEY = "SkinControllerSave";
        ...
        public void Save()
        {
            ES3.Save<SkinControllerSave>(SAVE_KEY, this);
        }
        ...
        public void Load()
        {
            ...
            {
                ES3.Load<SkinControllerSave>(SAVE_KEY, this);
            }
        }
    }
}
